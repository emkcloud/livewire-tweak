...
The configuration file is optional. You can simply define the variables directly in your .env file. However, if you need to customize how certain options are calculated, you can publish the configuration file to your config directory using the following command:
